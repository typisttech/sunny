...
/**
 * @package   Make_API_Call
 * @author    Tang Rufus <tangrufus@gmail.com>
 */

/**
 * A flok from CloudFlare-API by VEXXHOST, Inc.
 * Make CloudFlare Client API calls by wp_remote_post
 *
...
class CloudFlare_API_Helper {
    ...
    private function __construct()
    {
        ...
        $this->email = $plugin->get_cloudflare_email();
        $this->token_key = $plugin->get_cloudflare_api_key();
    }
