...
jQuery(window).load(function () {
    ...
    function resetResultArea() {
        jQuery('div#sunny_target_debugger-result').replaceWith(
            '<div id="sunny_target_debugger-result">' +
    ...
    function getResult() {
        jQuery.ajax({
            ...
            jQuery('div#sunny_target_debugger-result').replaceWith(
                '<div id="sunny_target_debugger-result">' +
                '<table id="sunny_target_debugger-table" class="widefat striped cache-status">' +
                '<thead>' +
                '<tr>' +
                ...
                '</tr>' +
                '</thead>' +
                '<tbody id="sunny_target_debugger-result-body"></tbody>' +
                '</table>' +
                '</div>'
            );

            jQuery.map(response, function (values, index) {
                jQuery('tbody#sunny_target_debugger-result-body').append(
                    "<tr id='" + index + "'>" +
